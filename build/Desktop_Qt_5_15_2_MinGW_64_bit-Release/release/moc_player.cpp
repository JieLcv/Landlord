...
QT_MOC_LITERAL(1, 7, 17), // "notifyGrapLordBet"
...
QT_MOC_LITERAL(9, 71, 15) // "notifyPickCards"
    ...
    "Player\0notifyGrapLordBet\0\0Player*\0"
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->notifyGrapLordBet((*reinterpret_cast< Player*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Player::notifyGrapLordBet)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Player::notifyGrapLordBet(Player * _t1, int _t2)
{
