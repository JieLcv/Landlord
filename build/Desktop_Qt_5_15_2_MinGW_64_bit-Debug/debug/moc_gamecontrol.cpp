...
QT_MOC_LITERAL(6, 61, 6), // "statue"
QT_MOC_LITERAL(7, 68, 17), // "notifyGrapLordBet"
...
QT_MOC_LITERAL(12, 124, 6), // "status"
QT_MOC_LITERAL(13, 131, 14), // "notifyPlayHand"
QT_MOC_LITERAL(14, 146, 6), // "Cards&"
QT_MOC_LITERAL(15, 153, 5), // "cards"
QT_MOC_LITERAL(16, 159, 11) // "pendingInfo"

    },
    "GameControl\0playerStatusChanged\0\0"
    "Player*\0player\0PlayerStatus\0statue\0"
    "notifyGrapLordBet\0bet\0flag\0gameStatusChanged\0"
    "GameStatus\0status\0notifyPlayHand\0"
    "Cards&\0cards\0pendingInfo"
};
...
void GameControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->notifyGrapLordBet((*reinterpret_cast< Player*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameControl::notifyGrapLordBet)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void GameControl::notifyGrapLordBet(Player * _t1, int _t2, bool _t3)
{
